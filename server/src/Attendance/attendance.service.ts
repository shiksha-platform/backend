...
export class AttendanceService {
  ...
  public async findReportRecords(
    fromDate: string,
    toDate: string,
    topicId: string,
    eventId: string,
  ...
  public async updateAttendance(
    ...
    try {
      return await this.attendanceRepository.update(
        attendanceId,
        attendanceDto
      );
    } catch (err) {
  ...
  public async findAttendanceByClass(
    searchClassId: String,
    fromDate: String,
    toDate: String
  ) {}

  public async findAttendanceByClassAndSubject(
    classId: String,
    subjectId: String,
    fromDate: String,
    toDate: String
